...
def acceleration_velocity_time():
    ...
    if answer == "acceleration":
        ...
        get_time = get_float("Enter time: ")
        print("Result: ",get_acceleration*get_time)
    
    elif answer == "time":       
        get_acceleration = get_non_zero_float("Enter acceleration: ", "Acceleration")
        get_velocity = get_float("Enter velocity: ")
        print("Result: ",get_velocity/get_acceleration)
    else:
        print("Please enter a valid field from the above")
...
def force_mass_acceleration():
    ...
    if answer == "acceleration":
        ...
        print("Result: ",get_force/get_mass)
        
    elif answer == "force":
        get_acceleration = get_float("Enter acceleration: ")
        get_mass = get_non_zero_float("Enter mass: ", "Mass")
        print("Result: ",get_acceleration*get_mass)
    
    elif answer == "mass":       
        get_acceleration = get_non_zero_float("Enter acceleration: ", "Acceleration")
        get_force = get_float("Enter force: ")
        print("Result: ",get_force/get_acceleration)
    else:
        print("Please enter a valid field from the above")
...
def momentum_mass_velocity():
    ...
    if answer == "velocity":
        ...
        get_mass = get_non_zero_float("Enter mass: ", "Mass") 
        print("Result: ",get_momentum/get_mass)
        
    elif answer == "momentum":
        get_velocity = get_float("Enter velocity: ")
        get_mass = get_non_zero_float("Enter mass: ", "Mass")
        print("Result: ",get_velocity*get_mass)
    
    elif answer == "mass":       
        get_velocity = get_non_zero_float("Enter velocity: ", "Velocity")
        get_momentum = get_float("Enter momentum: ")
        print("Result: ",get_momentum/get_velocity)
    else:
        print("Please enter a valid field from the above")
...
def impulse_force_time():
    ...
    if answer == "force":
        ...
        get_time = get_non_zero_float("Enter time: ", "Time") 
        print("Result: ",get_impulse/get_time)
        
    elif answer == "impulse":
        get_force = get_float("Enter force: ")
        get_time = get_non_zero_float("Enter time: ", "Time")
        print("Result: ",get_force*get_time)
    
    elif answer == "time":       
        get_force = get_non_zero_float("Enter force: ", "Force")
        get_impulse = get_float("Enter impulse: ")
        print("Result: ",get_impulse/get_force)
    else:
        print("Please enter a valid field from the above")
...
def torque_force_radius():
    ...
    if answer == "force":
        ...
        print("Result: ",get_torque/get_radius)
        
    elif answer == "torque":
        get_force = get_float("Enter force: ")
        get_radius = get_non_zero_float("Enter radius: ", "Radius")
        print("Result: ",get_force*get_radius)
    
    elif answer == "radius":       
        get_force = get_non_zero_float("Enter force: ", "Force")
        get_torque = get_float("Enter torque: ")
        print("Result: ",get_torque/get_force)
    else:
        print("Please enter a valid field from the above")
...
def work_force_displacement():
    ...
    if answer == "force":
        ...
        print("Result: ",get_work/get_displacement)
        
    elif answer == "work":
        get_force = get_float("Enter force: ")
        get_displacement = get_non_zero_float("Enter displacement: ", "Displacement")
        print("Result: ",get_force*get_displacement)
    
    elif answer == "displacement":       
        get_force = get_non_zero_float("Enter force: ", "Force")
        get_work = get_float("Enter work: ")
        print("Result: ",get_work/get_force)
    else:
        print("Please enter a valid field from the above")
...
def potential_mass_height():
    ...
    if answer == "height":
        ...
        get_mass = get_non_zero_float("Enter mass: ", "Mass") 
        print("Result: ",get_potential/(get_mass*9.8))
        
    elif answer == "potential":
        get_height = get_float("Enter height: ")
        get_mass = get_non_zero_float("Enter mass: ", "Mass")
        print("Result: ",get_height*get_mass*9.8)
    
    elif answer == "mass":       
        get_height = get_non_zero_float("Enter height: ", "Height")
        get_potential = get_float("Enter potential energy: ")
        print("Result: ",get_potential/(get_height*9.8))
    else:
        print("Please enter a valid field from the above")
...
def kinetic_mass_velocity():
    ...
    if answer == "velocity":
        ...
        get_mass = get_non_zero_float("Enter mass: ", "Mass") 
        print("Result: ",math.sqrt((2*get_kinetic)/get_mass))
        
    elif answer == "kinetic":
        get_velocity = get_float("Enter velocity: ")
        get_mass = get_non_zero_float("Enter mass: ", "Mass")
        print("Result: ",(get_mass*(get_velocity**2))/2)
    
    elif answer == "mass":       
        get_velocity = get_non_zero_float("Enter velocity: ", "Velocity")
        get_kinetic = get_float("Enter kinetic energy: ")
        print("Result: ",(2*get_kinetic)/(get_velocity**2))
    else:
        print("Please enter a valid field from the above")